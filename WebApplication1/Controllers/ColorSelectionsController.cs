...
{
    ////////////////////////////////////////////////////////////////////////////////////////////////////
    /// <summary>   A controller for handling color selections. </summary>
    ///
    /// <remarks>   Aedmonds, 8/25/2017. </remarks>
    ////////////////////////////////////////////////////////////////////////////////////////////////////

    [Authorize]
    public class ColorSelectionsController : ApiController
    {
        ...
        public ColorSelectionsController()
        {
        }
        ...
        public ColorSelectionsController(ApplicationUserManager userManager)
        {
        ...
        // GET: api/ColorSelections
        public IQueryable<ColorSelection> GetColorSelections()
        {
            var user = UserManager.FindById(User.Identity.GetUserId());
            return db.ColorSelections.Where(r => r.Workspace.UserId == user.UserName && r.Favorite == false).OrderByDescending(r => r.TimeStamp);
        }
