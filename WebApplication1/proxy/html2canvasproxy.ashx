...
public class Html2CanvasProxy : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        foreach(String key in context.Request.QueryString.AllKeys)
        {
            ...
            {
                case "callback":
                    getcallback = context.Request.QueryString[key];
                    break;
                case "url":
                    geturl = context.Request.QueryString[key];
                    break;
                default:
                    queryStrings = String.Concat(queryStrings, "&", key, "=", context.Request.QueryString[key].ToString());
                    break;
            }
        }
        ...
        if (getcallback == "" || getcallback == null) {
            ...
            if (ERR == "") {
                ...
                WebRequest request = WebRequest.Create(httpType + "://" + geturl + queryStrings);
                ...
                try {
                    ...
                    if (response.StatusCode != HttpStatusCode.OK) {
                        ...
                        if ("|application/octet-stream|image/jpeg|image/jpg|image/png|image/gif|image/svg+xml|image/svg-xml|text/html|application/xhtml|application/xhtml+xml|".IndexOf("|" + MIME + "|")== - 1) {
                            ...
                            if (System.IO.File.Exists(realpath + "\\" + shafile)) {
                                ...
                                if (CROSSDOMAIN) {
                                    ...
                                    string fullurl = "http://";
                                    if (context.Request.Url.Port == 443 || context.Request.Url.Port == 44300) {
                                        fullurl = "https://";
                                    }
