            ...
            if (!dataModel.getAccessToken()) {
                ...
                if (fragment.access_token) {
                    ...
                    if(window.location.pathname !== "/"){
                        window.location = "/Account/Authorize?client_id=web&response_type=token&state=" + encodeURIComponent(window.location.hash) + "&returnUrl=" + encodeURIComponent(window.location);
                    }
                }
            }
